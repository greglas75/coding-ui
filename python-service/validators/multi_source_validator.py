...
class MultiSourceValidator:
    ...
    async def validate(
        ...
        async def run_vision_ai():
            ...
            # Combine image URLs from both searches (6 + 6 = 12)
            all_image_urls = [r.url for r in dual_results.search_a_results[:6]]
            all_image_urls += [r.url for r in dual_results.search_b_results[:6]]
            ...
            for i, result in enumerate(vision_results.results):
                ...
                # First 6 are from Search A, next 6 from Search B
                if i < 6:
        ...
        with timer.measure("tier_5_pattern_detection"):
            ...
            # Collect raw data for frontend display
            raw_image_urls = []
            for result in dual_results.search_a_results + dual_results.search_b_results:
