-- ============================================================================
-- AI Cost Tracking Migration - FIXED VERSION v2
...
DROP POLICY IF EXISTS "Service role has full access" ON ai_usage_logs;
DROP POLICY IF EXISTS "Allow all inserts" ON ai_usage_logs;
DROP POLICY IF EXISTS "Allow all selects" ON ai_usage_logs;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'AI cost columns already exist in codeframe_generations';
    END IF;
END $$;
...
BEGIN
    ...
    RAISE NOTICE '  - codeframe_generations: AI columns verified';
    RAISE NOTICE '========================================';
END $$;
