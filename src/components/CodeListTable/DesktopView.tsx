/**
 * Desktop Table View
 * Renders code list as a table for desktop screens
 */
...
interface DesktopViewProps {
  ...
  sortOrder: 'asc' | 'desc';
  onSort: (field: keyof CodeWithCategories) => void;
  onStartEditingName: (code: CodeWithCategories) => void;
  onSaveName: (codeId: number) => void;
  onCancelEditingName: () => void;
  onStartEditingCategories: (code: CodeWithCategories) => void;
  onToggleCategory: (categoryId: number) => void;
  onSaveCategories: (codeId: number) => void;
  onCancelEditingCategories: () => void;
...
export function DesktopView(props: DesktopViewProps) {
  const {
    ...
    onSaveName,
    onCancelEditingName,
    onStartEditingCategories,
    onToggleCategory,
    onSaveCategories,
    onCancelEditingCategories,
    onToggleWhitelist,
    onDelete,
    setTempName,
    formatDate,
                ...
                {editingCategories === code.id ? (
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-1">
                      ...
                      <button
                        onClick={onCancelEditingCategories}
                  ...
                  <div className="flex flex-wrap gap-1">
                    ...
                    <button
                      onClick={() => onStartEditingCategories(code)}
